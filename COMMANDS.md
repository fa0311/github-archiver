...
github-archiver/0.0.0 linux-x64 node-v24.16.0
...
Archive Git repositories as local mirror clones

```
USAGE
  $ github-archiver archive INPUT [-o <value>] [-q] [--provider github|gitlab|gitea] [--help] [--version]

ARGUMENTS
  INPUT  HTTPS repository URL to archive

FLAGS
  -o, --output=<value>     [default: archives/{name}] Output directory pattern
  -q, --quiet              Suppress progress output
      --help               Show CLI help.
      --provider=<option>  [default: github] Repository provider
                           <options: github|gitlab|gitea>
...
```
USAGE
  $ github-archiver schedule [CONFIG] [--runOnce] [--help] [--version]
